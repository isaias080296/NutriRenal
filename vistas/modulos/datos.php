...
<br>
      <div class="input-group">
          ...
          <select class="form-control input-lg" id="cliente" name="cliente" required>
            <option value="">Tiene Fatiga</option>
...
<br>
  ...
  <br>
     ...
     <div class="input-group">
          ...
          <select class="form-control input-lg" id="cliente" name="cliente" required>
            <option value="">Realiza Actividad Fisica</option>
...
<br>
  ...
  <!-- Capacidad para Trabajar-->
      ...
      <h4 class="modal-title">Habilidades y Conocimiento</h4>
...
<br>
    ...
    <div class="input-group">
          ...
          <select class="form-control input-lg" id="cliente" name="cliente" required>
            <option value="">Temas Relacionados con Nutrición</option>
     ...
     <br>
          ...
          <select class="form-control input-lg" id="cliente" name="cliente" required>
            <option value="">Modificaciones Dieteticas</option>
